/*
		...
		Логика работы: 
			...
			6) Зная, что в шрифтах есть watermark'и (читай constants.js) и от них нельзя избавиться
				 {
			...
			7) Выводим содержимое на холст --> while(symb_num<lecture_base.length){ here }
				 {
					 Суть: выводим страницу построчно: цикл "for" выводит одну строку, затем еще...,
						...
						8. Если закончилась посленяя строка добавляем в массив output_info[] номер символа с которого начнется след. странца
