...
let volk_array = ['Хах, ты что, реально ВОЛКА в клетку решил загнать? Ну ты ОТЖИШАЕШЬ © Прометей - ОЧИСТИ СРАНИЦУ','Волка В клетку не посадишь © Кант (который философ) - ОЧИСТИ СРАНИЦУ','Волка в клетку посадишь, Окажешься на Мушкете моего Мушкета, © Александр Дюма - ОЧИСТИ СРАНИЦУ','Клетка - место Льва и Тигра, ВОЛК уж точно там не свой © Ярослав Мудрый - ОЧИСТИ СРАНИЦУ','В клеку можешь цифры поместить, но не Волка © Пифагор - ОЧИСТИ СРАНИЦУ','В волке много клеток и другой биологической массы, но в Клетке Волков нету. © Аристотель - ОЧИСТИ СРАНИЦУ']
...
let type_of_page = 0;       //  Тип страницы 0-Левый лист, 1 - Правый (нужен для установки параметров в set_arguments())
...
let page_set = [[0.2,-0.2,   43,20,    43,20,    560,825, 560, 825],
                ...
                [0,0,        31,20,    29,20,    520,720, 510, 670]
               ];   
...
let selected_font = ["ver_1_1","ver_1_2", 0];
